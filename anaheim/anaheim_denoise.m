...
% spectrum
[u1l, lam_l]  = eig(L1l); eig_L1l = diag(lam_l); u_g = u1l(:,220:end); lam_g = eig_L1l(220:end);
[u1, lam]= eig(L1); eig_L1 = diag(lam); u_h = u1(:,1:165);
[u1u, lam_u]= eig(L1u); eig_L1u = diag(lam_u); u_c = u1u(:,581:end);lam_c = eig_L1u(581:end);
...
cvx_begin
    ...
    minimize( norm(f_initial-f_opt)+0.1*norm(z,1) );
    subject to 
        B1*f_opt == z;
cvx_end
f_l1 = f_opt;
