...
clear;
close all;
addpath('/Users/yangmaosheng/Library/CloudStorage/OneDrive-DelftUniversityofTechnology/Topological filter/codes from 15 update/experiments/barcelona')
...
num_nodes = 1020; num_edges = 1798; num_tri = 164;
I = eye(num_edges);
...
% spectrum
[u1l, lam_l]  = eig(L1l); eig_L1l = diag(lam_l); u_g = u1l(:,870:end); lam_g = eig_L1l(870:end);
[u1, lam]= eig(L1); eig_L1 = diag(lam); u_h = u1(:,1:706);
[u1u, lam_u]= eig(L1u); eig_L1u = diag(lam_u); u_c = u1u(:,1636:end);lam_c = eig_L1u(1636:end);
